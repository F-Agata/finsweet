    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <TitleAndText variant={'title1'} mb={24}>Grow your Sales and Services</TitleAndText>
                    <TitleAndText variant={'textLarge'} mb={32} >Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.
                    </TitleAndText>
                    <Box
                    ...
                    >
                        <Link  href={`/#`}>
                            <Btn variant={'colorBgTransparent'} m={0}> Get started</Btn>
                        </Link>
                        <Link href={`/contact`}>
